        ...
        <div class="form__container-two">
            ...
            <div class="form__item <?=$class = $error_list["category"] ? $error_list["input_class"] : "";?>">
                ...
                <select id="category" name="category" required>
                    <option <?php if ($error_savings and $error_savings["category"] == "Выберите категорию") {print("selected");} else {print("");}; ?>>Выберите категорию</option>
                    <option <?php if ($error_savings and $error_savings["category"] == "Доски и лыжи") {print("selected");} else {print("");}; ?>>Доски и лыжи</option>
                    <option <?php if ($error_savings and $error_savings["category"] == "Крепления") {print("selected");} else {print("");}; ?>>Крепления</option>
                    <option <?php if ($error_savings and $error_savings["category"] =="Ботинки") {print("selected");} else {print("");}; ?>>Ботинки</option>
                    <option <?php if ($error_savings and $error_savings["category"] == "Одежда") {print("selected");} else {print("");}; ?>>Одежда</option>
                    <option <?php if ($error_savings and $error_savings["category"] == "Инструменты") {print("selected");} else {print("");}; ?>>Инструменты</option>
                    <option <?php if ($error_savings and $error_savings["category"] == "Разное") {print("selected");} else {print("");}; ?>>Разное</option>
                </select>
